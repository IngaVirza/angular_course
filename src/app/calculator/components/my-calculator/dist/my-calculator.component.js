...
exports.MyCalculatorComponent = void 0;
...
var MyCalculatorComponent = /** @class */ (function () {
    ...
    MyCalculatorComponent.prototype.addGroup = function () {
    ...
    MyCalculatorComponent.prototype.removeGroup = function (index) {
        this.calcGroups.splice(index, 1);
    };
    MyCalculatorComponent.prototype.calcGroup = function () {
        var _this = this;
        var result = 0;
        var tempHistory = [];
    ...
    MyCalculatorComponent.prototype.caclValueWithModif = function (value) {
    ...
    MyCalculatorComponent.prototype.calc = function (first, second, operation) {
        switch (operation) {
    ...
    MyCalculatorComponent = __decorate([
        core_1.Component({
    ...
    return MyCalculatorComponent;
}());
exports.MyCalculatorComponent = MyCalculatorComponent;
